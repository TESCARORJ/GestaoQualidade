...
//{
//    public class IndicadorDuracaoProcessoLicitacaoRepository : BaseRepository<IndicadorDuracaoProcessoLicitacao>, IIndicadorDuracaoProcessoLicitacaoRepository
//    {
//        private readonly ISession _session;
//        private readonly ILogCrudRepository _logCrudRepository;
//        private readonly ILogTabelaRepository _logTabelaRepository;

//        public IndicadorDuracaoProcessoLicitacaoRepository(ISession session, ILogCrudRepository logCrudRepository, ILogTabelaRepository logTabelaRepository) : base(session)
//        {
//            _session = session;
...
//        public IList<IndicadorDuracaoProcessoLicitacao> GetAllAtivos()
//        {
...
//        {
//            List<IndicadorDuracaoProcessoLicitacao> lista = GetAllAtivos().OrderBy(x => x.Id).ToList();
