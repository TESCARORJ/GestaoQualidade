...
//{
//    public class DefeitoSoldagemRepository : BaseRepository<DefeitoSoldagem>, IDefeitoSoldagemRepository
//    {
//        private readonly ISession _session;
//        private readonly ILogCrudRepository _logCrudRepository;
//        private readonly ILogTabelaRepository _logTabelaRepository;

//        public DefeitoSoldagemRepository(ISession session, ILogCrudRepository logCrudRepository, ILogTabelaRepository logTabelaRepository) : base(session)
//        {
//            _session = session;
...
//        public IList<DefeitoSoldagem> GetAllAtivos()
//        {
...
//        {
//            List<DefeitoSoldagem> lista = GetAllAtivos().OrderBy(x => x.Id).ToList();
