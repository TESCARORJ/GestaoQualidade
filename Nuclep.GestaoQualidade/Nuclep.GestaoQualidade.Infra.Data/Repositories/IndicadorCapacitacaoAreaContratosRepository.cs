...
//{
//    public class IndicadorCapacitacaoAreaContratosRepository : BaseRepository<IndicadorCapacitacaoAreaContratos>, IIndicadorCapacitacaoAreaContratosRepository
//    {
//        private readonly ISession _session;
//        private readonly ILogCrudRepository _logCrudRepository;
//        private readonly ILogTabelaRepository _logTabelaRepository;

//        public IndicadorCapacitacaoAreaContratosRepository(ISession session, ILogCrudRepository logCrudRepository, ILogTabelaRepository logTabelaRepository) : base(session)
//        {
//            _session = session;
...
//        public IList<IndicadorCapacitacaoAreaContratos> GetAllAtivos()
//        {
...
//        {
//            List<IndicadorCapacitacaoAreaContratos> lista = GetAllAtivos().OrderBy(x => x.Id).ToList();
