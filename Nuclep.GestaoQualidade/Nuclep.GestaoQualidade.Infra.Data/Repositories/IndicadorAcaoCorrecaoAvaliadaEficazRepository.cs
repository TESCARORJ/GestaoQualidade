...
//{
//    public class IndicadorAcaoCorrecaoAvaliadaEficazRepository : BaseRepository<IndicadorAcaoCorrecaoAvaliadaEficaz>, IIndicadorAcaoCorrecaoAvaliadaEficazRepository
//    {
//        private readonly ISession _session;
//        private readonly ILogCrudRepository _logCrudRepository;
//        private readonly ILogTabelaRepository _logTabelaRepository;

//        public IndicadorAcaoCorrecaoAvaliadaEficazRepository(ISession session, ILogCrudRepository logCrudRepository, ILogTabelaRepository logTabelaRepository) : base(session)
//        {
//            _session = session;
...
//        public IList<IndicadorAcaoCorrecaoAvaliadaEficaz> GetAllAtivos()
//        {
...
//        {
//            List<IndicadorAcaoCorrecaoAvaliadaEficaz> lista = GetAllAtivos().OrderBy(x => x.Id).ToList();
