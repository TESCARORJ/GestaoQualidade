...
//{
//    public class IndicadorRetrabalhoDocumentosRepository : BaseRepository<IndicadorRetrabalhoDocumentos>, IIndicadorRetrabalhoDocumentosRepository
//    {
//        private readonly ISession _session;
//        private readonly ILogCrudRepository _logCrudRepository;
//        private readonly ILogTabelaRepository _logTabelaRepository;

//        public IndicadorRetrabalhoDocumentosRepository(ISession session, ILogCrudRepository logCrudRepository, ILogTabelaRepository logTabelaRepository) : base(session)
//        {
//            _session = session;
...
//        public IList<IndicadorRetrabalhoDocumentos> GetAllAtivos()
//        {
...
//        {
//            List<IndicadorRetrabalhoDocumentos> lista = GetAllAtivos().OrderBy(x => x.Id).ToList();
