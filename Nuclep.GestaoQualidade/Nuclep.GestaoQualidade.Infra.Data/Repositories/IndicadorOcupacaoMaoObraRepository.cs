...
//{
//    public class IndicadorOcupacaoMaoObraRepository : BaseRepository<IndicadorOcupacaoMaoObra>, IIndicadorOcupacaoMaoObraRepository
//    {
//        private readonly ISession _session;
//        private readonly ILogCrudRepository _logCrudRepository;
//        private readonly ILogTabelaRepository _logTabelaRepository;

//        public IndicadorOcupacaoMaoObraRepository(ISession session, ILogCrudRepository logCrudRepository, ILogTabelaRepository logTabelaRepository) : base(session)
//        {
//            _session = session;
...
//        public IList<IndicadorOcupacaoMaoObra> GetAllAtivos()
//        {
...
//        {
//            List<IndicadorOcupacaoMaoObra> lista = GetAllAtivos().OrderBy(x => x.Id).ToList();
