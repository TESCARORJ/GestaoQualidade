...
//{
//    public class IndicadorReducaoRNCRepository : BaseRepository<IndicadorReducaoRNC>, IIndicadorReducaoRNCRepository
//    {
//        private readonly ISession _session;
//        private readonly ILogCrudRepository _logCrudRepository;
//        private readonly ILogTabelaRepository _logTabelaRepository;

//        public IndicadorReducaoRNCRepository(ISession session, ILogCrudRepository logCrudRepository, ILogTabelaRepository logTabelaRepository) : base(session)
//        {
//            _session = session;
...
//        public IList<IndicadorReducaoRNC> GetAllAtivos()
//        {
...
//        {
//            List<IndicadorReducaoRNC> lista = GetAllAtivos().OrderBy(x => x.Id).ToList();
