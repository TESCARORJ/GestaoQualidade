...
//{
//    public class IndicadorEventosAtrasoRepository : BaseRepository<IndicadorEventosAtraso>, IIndicadorEventosAtrasoRepository
//    {
//        private readonly ISession _session;
//        private readonly ILogCrudRepository _logCrudRepository;
//        private readonly ILogTabelaRepository _logTabelaRepository;

//        public IndicadorEventosAtrasoRepository(ISession session, ILogCrudRepository logCrudRepository, ILogTabelaRepository logTabelaRepository) : base(session)
//        {
//            _session = session;
...
//        public IList<IndicadorEventosAtraso> GetAllAtivos()
//        {
...
//        {
//            List<IndicadorEventosAtraso> lista = GetAllAtivos().OrderBy(x => x.Id).ToList();
