...
{
    public class IndicadorRespostaAreasPrazoOriginalMetaMap : ClassMap<IndicadorRespostaAreasPrazoOriginalMeta>
    {
        public IndicadorRespostaAreasPrazoOriginalMetaMap()
        {
            Table("IndicadorRespostaAreasPrazoOriginalMeta");
