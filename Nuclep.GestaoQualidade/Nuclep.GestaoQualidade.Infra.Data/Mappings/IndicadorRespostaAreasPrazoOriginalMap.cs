...
{
    public class IndicadorRespostaAreasPrazoOriginalMap:ClassMap<IndicadorRespostaAreasPrazoOriginal>
    {
        public IndicadorRespostaAreasPrazoOriginalMap()
        {
            Table("IndicadorRespostaAreasPrazoOriginal");
