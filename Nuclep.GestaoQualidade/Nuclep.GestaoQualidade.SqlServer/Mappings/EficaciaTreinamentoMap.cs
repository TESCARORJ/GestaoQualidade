...
{
    public class EficaciaTreinamentoMap : IEntityTypeConfiguration<EficaciaTreinamento>
    {
        public void Configure(EntityTypeBuilder<EficaciaTreinamento> builder)
        {
            builder.ToTable("Ind_EficaciaTreinamento");
