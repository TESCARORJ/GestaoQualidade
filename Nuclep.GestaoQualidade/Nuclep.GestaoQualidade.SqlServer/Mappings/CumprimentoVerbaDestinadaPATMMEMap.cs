...
{
    public class CumprimentoVerbaDestinadaPATMMEMap : IEntityTypeConfiguration<CumprimentoVerbaDestinadaPATMME>
    {
        public void Configure(EntityTypeBuilder<CumprimentoVerbaDestinadaPATMME> builder)
        {
            builder.ToTable("Ind_CumprimentoVerbaDestinadaPATMME");

            builder.HasKey(e => e.Id);

            builder.Property(e => e.Ano).HasColumnName("Ano").HasColumnType("int");

            builder.Property(e => e.Semestre).HasColumnName("Semestre").HasColumnType("int");
