...
{
    public class TempoMedioEmissaoOCItensCriticosMap : IEntityTypeConfiguration<TempoMedioEmissaoOCItensCriticos>
    {
        public void Configure(EntityTypeBuilder<TempoMedioEmissaoOCItensCriticos> builder)
        {
            builder.ToTable("Ind_TempoMedioEmissaoOCItensCriticos");
