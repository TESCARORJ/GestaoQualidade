...
{
    public class RejeicaoMateriaisMetaMap : IEntityTypeConfiguration<RejeicaoMateriaisMeta>
    {
        public void Configure(EntityTypeBuilder<RejeicaoMateriaisMeta> builder)
        {
            builder.ToTable("Ind_RejeicaoMateriaisMeta");
            ...
            builder.HasOne(e => e.UsuarioCadastro)
                .WithOne()
                .HasForeignKey<RejeicaoMateriaisMeta>(e => e.UsuarioCadastroId)
