...
{
    public class SatisfacaoUsuarioMap : IEntityTypeConfiguration<SatisfacaoUsuario>
    {
        public void Configure(EntityTypeBuilder<SatisfacaoUsuario> builder)
        {
            builder.ToTable("Ind_SatisfacaoUsuario");
