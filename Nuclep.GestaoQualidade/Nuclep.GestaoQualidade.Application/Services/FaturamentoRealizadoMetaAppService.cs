    ...
    public class FaturamentoRealizadoMetaAppService : IFaturamentoRealizadoMetaAppService
    {
        ...
        public async Task<FaturamentoRealizadoMetaResponseDTO> DeleteAsync(long id)
        {
            ...
            var logCrud = new LogCrud
            {
                ...
                Descricao = $"Meta Faturamento Realizado do período {model.Meta} excluída no sistema por {usuarioLogado.Nome}, ID: {usuarioLogado.Id} em {DateTime.Now}."
            };
        ...
        private async Task<List<LogCrud>> Logar(FaturamentoRealizadoMetaRequestDTO request, string tabela)
        {
