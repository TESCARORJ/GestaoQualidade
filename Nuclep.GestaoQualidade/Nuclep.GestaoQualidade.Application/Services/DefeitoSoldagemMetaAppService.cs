    ...
    public class DefeitoSoldagemMetaAppService : IDefeitoSoldagemMetaAppService
    {
        ...
        public async Task<DefeitoSoldagemMetaResponseDTO> DeleteAsync(long id)
        {
            ...
            var logCrud = new LogCrud
            {
                ...
                LogTabela = _logTabelaRepository.GetOneAsync(x => x.Nome.ToLower() == "Ind_DefeitoSoldagemMeta".ToLower()).Result,
        ...
        private List<LogCrud> Logar(DefeitoSoldagemMetaRequestDTO request, string tabela)
        {
