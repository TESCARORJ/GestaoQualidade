...
{
    public class TaxaConformidadeDocumentosQualidadeMetaAppService : ITaxaConformidadeDocumentosQualidadeMetaAppService
    {
        ...
        public TaxaConformidadeDocumentosQualidadeMetaAppService(
        ...
        public async Task<TaxaConformidadeDocumentosQualidadeMetaResponseDTO> AddAsync(TaxaConformidadeDocumentosQualidadeMetaRequestDTO request)
        {
            var model = _mapper.Map<TaxaConformidadeDocumentosQualidadeMeta>(request);
            ...
            var logs = Logar(request, "Ind_TaxaConformidadeDocumentosQualidadeMeta");
            ...
            using (var transaction = new TransactionScope(TransactionScopeAsyncFlowOption.Enabled))
            {
                try
                {
                    ...
                    return _mapper.Map<TaxaConformidadeDocumentosQualidadeMetaResponseDTO>(result);
        ...
        public async Task<TaxaConformidadeDocumentosQualidadeMetaResponseDTO> UpdateAsync(long id, TaxaConformidadeDocumentosQualidadeMetaRequestDTO request)
        {
            var model = _mapper.Map<TaxaConformidadeDocumentosQualidadeMeta>(request);
        ...
        public async Task<TaxaConformidadeDocumentosQualidadeMetaResponseDTO> DeleteAsync(long id)
        {
            ...
            var logCrud = new LogCrud
            {
                ...
                LogTabelaId = _logTabelaRepository.GetOneAsync(x => x.Nome.ToLower() == "Ind_TaxaConformidadeDocumentosQualidadeMeta".ToLower()).Result.Id,
                IdReferencia = model.Id,
                Descricao = $"Meta Autoavaliação Gerencial SGQ do período {model.Meta} excluída no sistema por {usuarioLogado.Nome}, ID: {usuarioLogado.Id} em {DateTime.Now}."
            };
        ...
        public async Task<TaxaConformidadeDocumentosQualidadeMetaResponseDTO> GetByIdAsync(long id)
        {
        ...
        public async Task<List<TaxaConformidadeDocumentosQualidadeMetaResponseDTO>> GetAllAsync()
        {
            var result = await _autoavaliacaoGerencialSGQMetaDomainService.GetAllAsync();

            return _mapper.Map<List<TaxaConformidadeDocumentosQualidadeMetaResponseDTO>>(result);
        }

        public async Task<List<TaxaConformidadeDocumentosQualidadeMetaResponseDTO>> GetAllAtivosAsync()
        {
        ...
        private async Task<List<LogCrud>> Logar(TaxaConformidadeDocumentosQualidadeMetaRequestDTO request, string tabela)
        {
            ...
            if (request.Id != 0)
            {
                TaxaConformidadeDocumentosQualidadeMeta requestOld = _mapper.Map<TaxaConformidadeDocumentosQualidadeMeta>(GetByIdAsync(request.Id).Result);
                TaxaConformidadeDocumentosQualidadeMeta requestNew = _mapper.Map<TaxaConformidadeDocumentosQualidadeMeta>(request);
